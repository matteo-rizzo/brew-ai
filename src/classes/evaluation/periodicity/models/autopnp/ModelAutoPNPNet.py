...
class ModelAutoPNPNet:
    ...
    def __init__(self, input_size, num_fourier_features: int = 16, num_chebyshev_terms: int = 5):
        self.network = AutoPNPNet(input_size, num_fourier_features, num_chebyshev_terms).to(DEVICE)
